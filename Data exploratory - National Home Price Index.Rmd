...
forecast_horizon <- 4
forecast_values <- predict(model, n.ahead = forecast_horizon)

# Compute MAPE
actual_values <- tail(price_q, forecast_horizon)
actual_values
forecasted_values <- forecast_values$pred
forecasted_values <- forecast_values$pred
forecasted_values <- ts(forecasted_values, start = c(2024, 1), frequency = 4)
forecasted_values
